...
namespace ETModel
{
    ...
    public sealed class EventSystem
    {
        ...
        public static float FixedUpdateTimeDelta
        {
            get
            {
        ...
        private readonly UnOrderMultiMap<Type, IFixedUpdateSystem> fixedUpdateSystems =
                new UnOrderMultiMap<Type, IFixedUpdateSystem>();
