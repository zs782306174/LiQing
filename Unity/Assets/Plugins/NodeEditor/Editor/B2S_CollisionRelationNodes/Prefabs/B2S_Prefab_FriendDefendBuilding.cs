...
{
    [Node(false, "Box2DSharp/预制件/友方防御塔", typeof (B2S_CollisionRelationCanvas))]
    public class B2S_Prefab_FriendDefendBuilding:Node
    {
                /// <summary>
                /// 内部ID
                /// </summary>
                private const string Id = "友方防御塔";
                ...
                {
                    this.MB2SCollisionInstance.Flag = "友方防御塔";
                    this.MB2SCollisionInstance.nodeDataId = B2S_PrefabIDDefine.FriendDefendBuilding;
                }
