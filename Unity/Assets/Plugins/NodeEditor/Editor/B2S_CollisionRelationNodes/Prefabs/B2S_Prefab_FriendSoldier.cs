...
{
    [Node(false, "Box2DSharp/预制件/友方士兵", typeof (B2S_CollisionRelationCanvas))]
    public class B2S_Prefab_FriendSoldier: Node
    {
        /// <summary>
        /// 内部ID
        /// </summary>
        private const string Id = "友方士兵";
        ...
        {
            this.MB2SCollisionInstance.Flag = "友方士兵";
            this.MB2SCollisionInstance.nodeDataId = B2S_PrefabIDDefine.FriendSoldier;
        }
