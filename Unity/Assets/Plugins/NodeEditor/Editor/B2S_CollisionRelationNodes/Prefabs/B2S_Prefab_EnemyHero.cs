...
{
    [Node(false, "Box2DSharp/预制件/敌方英雄", typeof (B2S_CollisionRelationCanvas))]
    public class B2S_Prefab_EnemyHero: Node
    {
        /// <summary>
        /// 内部ID
        /// </summary>
        private const string Id = "敌方英雄";
        ...
        private void OnEnable()
        {
            ...
            this.MB2SCollisionInstance.nodeDataId = B2S_PrefabIDDefine.EnemyHero;
        }
